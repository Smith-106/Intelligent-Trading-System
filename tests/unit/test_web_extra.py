...
class TestServiceBuildDemoFrame:
    ...
    def test_build_demo_frame_with_start(self):
        from quantflow.web.service import _build_demo_frame
        df = _build_demo_frame("BTC/USDT", start="2024-01-01", end="2024-06-01", bars=30, timeframe="1d")
        assert not df.empty
        assert "close" in df.columns
    ...
    def test_build_demo_frame_start_after_end(self):
        ...
        from quantflow.web.service import _build_demo_frame
        df = _build_demo_frame("BTC/USDT", start="2025-01-01", end="2024-01-01", bars=10, timeframe="4h")

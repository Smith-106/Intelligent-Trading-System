...
summary: 本项目 release.yml 对发布文档的形态有硬依赖：scripts/build_release.py 的 ensure_release_docs 要求 docs/release/vX.Y.Z/ 目录下存在 7 个固定文件（release-notes/upgrade-guide/rollback-plan/known-issues/test-report/security-report/release-standard-quantflow）。v0.5~v0.10 期间改用

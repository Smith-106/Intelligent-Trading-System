...
- `quantflow/strategy/ai_factors.py:20` — `AIFactorEngine` (Meta-Labeling, expanding CV splits)
- `quantflow/strategy/sentiment.py` — sentiment analysis (FinBERT per CLAUDE.md)
...
- AI layer: `MLEnsembleStrategy` + `AIFactorEngine` active; FinBERT/Qlib RD-Agent referenced in CLAUDE.md but **no implementation files** — planned/optional.

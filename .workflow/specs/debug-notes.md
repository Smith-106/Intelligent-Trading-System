...
<spec-entry category="debug" keywords="调试,日志,事件总线,异常,kill-switch" date="2026-05-29" sid="S-legacy-a38f0ecb" appliesToRepoIds="4df0e1f8-a4e6-4872-8eb3-857aef7909ed">
### 调试策略与日志规范
...
<spec-entry category="debug" keywords="VectorBTEngine,BacktestEngine,重命名,import-error" date="2026-06-02" sid="S-legacy-99946e76" appliesToRepoIds="4df0e1f8-a4e6-4872-8eb3-857aef7909ed">
...
<spec-entry category="debug" keywords="e712,ruff,autofix,pandas,numpy,bool" date="2026-07-05" sid="S-legacy-c8490c16" title="E712 on pandas/numpy bools: use bool(x), never accept the `is True` autofix" appliesToRepoIds="4df0e1f8-a4e6-4872-8eb3-857aef7909ed" description="ruff E712 unsafe autofix rewrites ==True to is True, which is False for np.bool_ — silently weakens assertions">
...
<spec-entry category="debug" keywords="yaml,pydantic,schema-drift,config-dropped,silently-ignored" date="2026-07-05" sid="S-legacy-81cd71dd" title="YAML key without a matching pydantic field is silently dropped at load time" appliesToRepoIds="4df0e1f8-a4e6-4872-8eb3-857aef7909ed" description="A default.yaml key with no model field is decorative; consumer hardcodes the same default so tests pass — config changes have zero effect">
...
<spec-entry category="debug" keywords="cwe-532,cwe-209,gateway,re-raise,credential-exposure,redaction" date="2026-07-24" sid="S-20260724-ne4k" title="CWE-532 gateway re-raise 致下游 unguarded" sourceRef="main@bb3c6cd" appliesToRepoIds="4df0e1f8-a4e6-4872-8eb3-857aef7909ed" description="gateway scrub 自己日志但 re-raise raw 异常；下游 sink（含 HTTP response）unguarded；choke point 缺失">

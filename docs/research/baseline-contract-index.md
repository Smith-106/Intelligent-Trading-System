...
| **B3** | [Candidate-Baseline-3.md](./Candidate-Baseline-3.md) | **`funding_rate`** (+ OI) vs classic | BTC-only A/B | **KEEP B0** (frozen T027) | `scripts/run_baseline3_challenger.py` → `baseline3/` + `adjudication_frozen.json` |
